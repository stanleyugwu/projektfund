            ...
            <section className="relative pb-16 md:pb-24">
                ...
                <div className="container mt-10">
                    <div className="md:flex">
                        <div className="space-y-5 md:px-3 lg:w-2/3 md:w-1/2 md:p-4">
                            <div>
                        ...
                        <div className="mt-8 md:px-3 lg:w-1/3 md:w-1/2 md:p-4 md:mt-0">
                            ...
                            <div className="mt-12 text-center">
                                ...
                                <div className="mt-6">
                                    <Button asChild variant={'outline'}>
                                        <a href="/contact" ><i className="align-middle uil uil-phone me-2" /> Contact us</a>
                                    </Button>
                                </div>
                            </div>
                            </div>
